...
>>>>>>> 9319fefe35 (vendor: github.com/moby/buildkit v0.22.0-rc2):vendor.mod
	...
	go.opentelemetry.io/contrib/processors/baggagecopy v0.9.0
...
require (
	...
	google.golang.org/genproto v0.0.0-20250505200425-f936aa4a68b2 // indirect; TODO(thaJeztah): should we keep this one aligned with the other google.golang.org/genproto/xxx modules?
